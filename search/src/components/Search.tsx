        ...
        <div className="bg-gray-500 p-10">
            <form className="flex items-center max-w-sm mx-auto" onSubmit={handleSearch}>   
                ...
                <div className="relative w-full">
                    <input type="text" value={search} onChange={e => setSearch(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 w-full p-3.5   dark:placeholder-gray-400  " placeholder="Search name..." />
                </div>
